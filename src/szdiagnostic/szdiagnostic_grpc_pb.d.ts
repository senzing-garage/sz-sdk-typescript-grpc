...
interface ISzDiagnosticService_ICheckRepositoryPerformance extends grpc.MethodDefinition<
...
interface ISzDiagnosticService_IGetFeature extends grpc.MethodDefinition<
...
interface ISzDiagnosticService_IGetRepositoryInfo extends grpc.MethodDefinition<
...
interface ISzDiagnosticService_IPurgeRepository extends grpc.MethodDefinition<
...
interface ISzDiagnosticService_IReinitialize extends grpc.MethodDefinition<
...
export interface ISzDiagnosticServer {
  checkRepositoryPerformance: grpc.handleUnaryCall<
    szdiagnostic_pb.CheckRepositoryPerformanceRequest,
    szdiagnostic_pb.CheckRepositoryPerformanceResponse
  >;
  getFeature: grpc.handleUnaryCall<
    ...
    szdiagnostic_pb.GetFeatureResponse
  >;
  getRepositoryInfo: grpc.handleUnaryCall<
    szdiagnostic_pb.GetRepositoryInfoRequest,
    szdiagnostic_pb.GetRepositoryInfoResponse
  >;
  purgeRepository: grpc.handleUnaryCall<
    szdiagnostic_pb.PurgeRepositoryRequest,
    szdiagnostic_pb.PurgeRepositoryResponse
  >;
...
export class SzDiagnosticClient
  extends grpc.Client
  implements ISzDiagnosticClient
{
  constructor(
    address: string,
  ...
  public checkRepositoryPerformance(
    request: szdiagnostic_pb.CheckRepositoryPerformanceRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: szdiagnostic_pb.CheckRepositoryPerformanceResponse,
