...
export class CheckRepositoryPerformanceRequest extends jspb.Message {
  ...
  ): CheckRepositoryPerformanceRequest.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: CheckRepositoryPerformanceRequest,
  ): CheckRepositoryPerformanceRequest.AsObject;
...
export class CheckRepositoryPerformanceResponse extends jspb.Message {
  ...
  toObject(
    includeInstance?: boolean,
  ): CheckRepositoryPerformanceResponse.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: CheckRepositoryPerformanceResponse,
  ): CheckRepositoryPerformanceResponse.AsObject;
  static serializeBinaryToWriter(
...
export class GetRepositoryInfoRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetRepositoryInfoRequest,
  ): GetRepositoryInfoRequest.AsObject;
  static serializeBinaryToWriter(
...
export class GetRepositoryInfoResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetRepositoryInfoResponse,
  ): GetRepositoryInfoResponse.AsObject;
  static serializeBinaryToWriter(
...
export class PurgeRepositoryRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: PurgeRepositoryRequest,
  ): PurgeRepositoryRequest.AsObject;
  static serializeBinaryToWriter(
...
export class PurgeRepositoryResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: PurgeRepositoryResponse,
  ): PurgeRepositoryResponse.AsObject;
  static serializeBinaryToWriter(
