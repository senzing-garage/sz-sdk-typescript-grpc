...
import {
  asString,
  bigIntToNumber,
  entityIdsAsJsonString,
  entityIdsToAvoidAsJson,
  newException,
  recordIdsAsJsonString,
  recordKeysToAvoidAsJson,
  requiredDataSourcesAsJson,
} from "./szHelpers";
import {
  SzError,
  SzNoGrpcConnectionError,
  SzNotYetImplementedError,
} from "./senzing/SzError";
...
export class SzGrpcWebEngine extends SzGrpcWebBase implements SzEngine {
  ...
  addRecord(
    ...
    engineFlags: BigInt | number = 0,
  ): Promise<string | SzError> {
  ...
  closeExportReport(exportHandle: number) {
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.closeExportReport(
          request,
          this._metadata,
          (err, res: CloseExportReportResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  countRedoRecords(): Promise<number> {
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.countRedoRecords(
          request,
          this._metadata,
          (err, res: CountRedoRecordsResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  exportJsonEntityReport(
    flags: BigInt | number = SzEngineFlags.SZ_EXPORT_DEFAULT_FLAGS,
  ) {}
  /**
   * NOT YET IMPLEMENTED
  ...
  findInterestingEntitiesByEntityId(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setFlags(bigIntToNumber(flags));
        this.client.findInterestingEntitiesByEntityId(
          request,
          this._metadata,
          (err, res: FindInterestingEntitiesByEntityIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  findInterestingEntitiesByRecordId(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setRecordId(recordId);
        request.setFlags(bigIntToNumber(flags));
        this.client.findInterestingEntitiesByRecordId(
          request,
          this._metadata,
          (err, res: FindInterestingEntitiesByRecordIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  findNetworkByEntityId(
    ...
    flags: BigInt | number = SzEngineFlags.SZ_FIND_NETWORK_DEFAULT_FLAGS,
  ) {
    return new Promise((resolve, reject) => {
      if (!this.client) {
        reject(new SzNoGrpcConnectionError());
      ...
      if (!findNetworkEntityIds) {
        ...
        this.waitForReady(this.getDeadlineFromNow(), (err) => {
          ...
          if (buildOutDegrees) {
            request.setBuildOutDegrees(buildOutDegrees as number);
          }
          if (buildOutMaxEntities) {
            request.setBuildOutMaxEntities(buildOutMaxEntities as number);
          }
          request.setFlags(bigIntToNumber(flags));
          this.client.findNetworkByEntityId(
            request,
            this._metadata,
            (err, res: FindNetworkByEntityIdResponse) => {
              if (err) {
                let _err = newException(err);
                reject(_err);
                throw _err;
  ...
  findNetworkByRecordId(
    recordKeys: Array<[string, number | string]>,
    maxDegrees?: number,
    buildOutDegrees?: number,
    buildOutMaxEntities?: number,
    flags: BigInt | number = SzEngineFlags.SZ_FIND_NETWORK_DEFAULT_FLAGS,
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!findNetworkRecordIds) {
        ...
        this.waitForReady(this.getDeadlineFromNow(), (err) => {
          ...
          request.setFlags(bigIntToNumber(flags));
          this.client.findNetworkByRecordId(
            request,
            this._metadata,
            (err, res: FindNetworkByRecordIdResponse) => {
              if (err) {
                let _err = newException(err);
                reject(_err);
                throw _err;
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        if (requiredDataSources) {
          request.setRequiredDataSources(
            requiredDataSourcesAsJson(requiredDataSources),
          );
        }
        request.setFlags(bigIntToNumber(flags));
        this.client.findPathByEntityId(
          request,
          this._metadata,
          (err, res: FindPathByEntityIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  findPathByRecordId(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setFlags(bigIntToNumber(flags));
        this.client.findPathByRecordId(
          request,
          this._metadata,
          (err, res: FindPathByRecordIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getActiveConfigId(): Promise<number | SzError> {
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.getActiveConfigId(
          request,
          this._metadata,
          (err, res: GetActiveConfigIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getEntityByEntityId(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setEntityId(entityId);
        request.setFlags(bigIntToNumber(flags));
        this.client.getEntityByEntityId(
          request,
          this._metadata,
          (err, res: GetEntityByEntityIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getEntityByRecordId(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setRecordId(recordId);
        request.setFlags(bigIntToNumber(flags));
        this.client.getEntityByRecordId(
          request,
          this._metadata,
          (err, res: GetEntityByRecordIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getRecord(
    dataSourceCode: string,
    recordId: string,
    flags: BigInt | number = SzEngineFlags.SZ_RECORD_DEFAULT_FLAGS,
  ): Promise<string | SzError> {
    return new Promise((resolve, reject) => {
      if (!this.client) {
        reject(new SzNoGrpcConnectionError());
  ...
  getRecordPreview(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setFlags(bigIntToNumber(flags));
        this.client.getRecordPreview(
          request,
          this._metadata,
          (err, res: GetRecordPreviewResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getRedoRecord(): Promise<string | SzError> {
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.getRedoRecord(
          request,
          this._metadata,
          (err, res: GetRedoRecordResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getVirtualEntityByRecordId(
    recordKeys: Array<[string, string | number]>,
    flags: BigInt | number = SzEngineFlags.SZ_VIRTUAL_ENTITY_DEFAULT_FLAGS,
  ): Promise<string | SzError> {
    return new Promise((resolve, reject) => {
      if (!this.client) {
        reject(new SzNoGrpcConnectionError());
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.getVirtualEntityByRecordId(
          request,
          this._metadata,
          (err, res: GetVirtualEntityByRecordIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  howEntityByEntityId(
    entityId: number,
    flags: BigInt | number = SzEngineFlags.SZ_HOW_ENTITY_DEFAULT_FLAGS,
  ): Promise<string | SzError> {
    return new Promise((resolve, reject) => {
      if (!this.client) {
        reject(new SzNoGrpcConnectionError());
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setEntityId(entityId);
        request.setFlags(bigIntToNumber(flags));
        this.client.howEntityByEntityId(
          request,
          this._metadata,
          (err, res: HowEntityByEntityIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  primeEngine() {
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.primeEngine(
          request,
          this._metadata,
          (err, res: PrimeEngineResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  processRedoRecord(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setFlags(bigIntToNumber(flags));
        this.client.processRedoRecord(
          request,
          this._metadata,
          (err, res: ProcessRedoRecordResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  reevaluateEntity(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setEntityId(entityId);
        request.setFlags(bigIntToNumber(flags));
        this.client.reevaluateEntity(
          request,
          this._metadata,
          (err, res: ReevaluateEntityResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  reevaluateRecord(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setRecordId(recordId);
        request.setFlags(bigIntToNumber(flags));
        this.client.reevaluateRecord(
          request,
          this._metadata,
          (err, res: ReevaluateRecordResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  searchByAttributes(
    ...
    flags:
      | BigInt
      | number = SzEngineFlags.SZ_SEARCH_BY_ATTRIBUTES_DEFAULT_FLAGS,
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.searchByAttributes(
          request,
          this._metadata,
          (err, res: SearchByAttributesResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  whyEntities(
    entityId1: number,
    entityId2: number,
    flags: BigInt | number = SzEngineFlags.SZ_WHY_ENTITIES_DEFAULT_FLAGS,
  ) {
    return new Promise((resolve, reject) => {
      if (!this.client) {
        reject(new SzNoGrpcConnectionError());
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setFlags(bigIntToNumber(flags));
        this.client.whyEntities(
          request,
          this._metadata,
          (err, res: WhyEntitiesResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  whyRecordInEntity(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setRecordId(recordId);
        request.setFlags(bigIntToNumber(flags));
        this.client.whyRecordInEntity(
          request,
          this._metadata,
          (err, res: WhyRecordInEntityResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  whyRecords(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setFlags(bigIntToNumber(flags));
        this.client.whyRecords(
          request,
          this._metadata,
          (err, res: WhyRecordsResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  whySearch(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        request.setSearchProfile(searchProfile);
        request.setFlags(bigIntToNumber(flags));
        this.client.whySearch(
          request,
          this._metadata,
          (err, res: WhySearchResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
