...
export class SzEngineFlags {
  static SZ_INCLUDE_FEATURE_HASHES = 1n << 41n;
  ...
  static SZ_EXPORT_INCLUDE_ALL_ENTITIES =
  ...
  static SZ_SEARCH_INCLUDE_RESOLVED =
    SzEngineFlags.SZ_EXPORT_INCLUDE_MULTI_RECORD_ENTITIES;
  static SZ_SEARCH_INCLUDE_POSSIBLY_SAME =
    SzEngineFlags.SZ_EXPORT_INCLUDE_POSSIBLY_SAME;
  static SZ_SEARCH_INCLUDE_POSSIBLY_RELATED =
    SzEngineFlags.SZ_EXPORT_INCLUDE_POSSIBLY_RELATED;
  static SZ_SEARCH_INCLUDE_NAME_ONLY =
  ...
  static SZ_RECORD_DEFAULT_FLAGS =
  ...
  static SZ_EXPORT_DEFAULT_FLAGS = (
  ...
  static SZ_SEARCH_BY_ATTRIBUTES_MINIMAL_ALL =
    SzEngineFlags.SZ_SEARCH_INCLUDE_ALL_ENTITIES;

  // Return minimal data with only the strongest matches.
  static SZ_SEARCH_BY_ATTRIBUTES_MINIMAL_STRONG =
    SzEngineFlags.SZ_SEARCH_INCLUDE_RESOLVED |
    SzEngineFlags.SZ_SEARCH_INCLUDE_POSSIBLY_SAME;

  // The recommended default flag values for search-by-attributes.
  static SZ_SEARCH_BY_ATTRIBUTES_DEFAULT_FLAGS =
