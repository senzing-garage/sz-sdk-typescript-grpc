...
interface ISzProductService_IGetLicense extends grpc.MethodDefinition<
...
interface ISzProductService_IGetVersion extends grpc.MethodDefinition<
...
export interface ISzProductServer {
  getLicense: grpc.handleUnaryCall<
    szproduct_pb.GetLicenseRequest,
    szproduct_pb.GetLicenseResponse
  >;
