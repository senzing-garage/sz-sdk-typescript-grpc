...
} from "./szconfigmanager/szconfigmanager_web_pb";
...
import {
  SzGrpcWebConfig as SzConfig,
  SzGrpcWebConfigOptions as SzConfigOptions,
} from "./szGrpcWebConfig";
 ...
 * @class
 */
export class SzGrpcWebConfigManager
  extends SzGrpcWebBase
  implements SzConfigManager
{
  private _client;
   ...
   */
  public createConfig(): Promise<SzConfig>;
  /**
   ...
   * representing that configuration.
   */
  public createConfig(configId: number): Promise<SzConfig>;
  /**
   ...
   */
  public createConfig(configDefinition: string): Promise<SzConfig>;
  /** @internal */
  public createConfig(
    definitionOrConfigId?: string | number,
  ): Promise<SzConfig> {
  ...
  public getTemplateConfig(): Promise<string> {
    return new Promise<string>((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.getTemplateConfig(
          request,
          this._metadata,
          (err, res: GetTemplateConfigResponse) => {
            if (err) {
  ...
  registerConfig(configDefinition: string, comment?: string) {
    return new Promise<number>((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.registerConfig(
          request,
          this._metadata,
          (err, res: RegisterConfigResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getConfigRegistry(): Promise<string> {
    return new Promise<string>((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.getConfigRegistry(
          request,
          this._metadata,
          (err, res: GetConfigRegistryResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  getDefaultConfigId(): Promise<number> {
    return new Promise<number>((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.getDefaultConfigId(
          request,
          this._metadata,
          (err, res: GetDefaultConfigIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  setDefaultConfig(
    ...
    comment?: string,
  ): Promise<number | SzError> | undefined {
    return new Promise<number>((resolve, reject) => {
      if (!this.client) {
        reject(new SzNoGrpcConnectionError());
        return;
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.setDefaultConfig(
          request,
          this._metadata,
          (err, res: SetDefaultConfigResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  setDefaultConfigId(configId: number): Promise<number | SzError> | undefined {
    return new Promise<number>((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.setDefaultConfigId(
          request,
          this._metadata,
          (err, res: SetDefaultConfigIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  replaceDefaultConfigId(
    ...
    return new Promise<string>((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.replaceDefaultConfigId(
          request,
          this._metadata,
          (err, res: ReplaceDefaultConfigIdResponse) => {
            if (err) {
              let _err = newException(err);
              reject(_err);
              throw _err;
  ...
  get szConfigGrpcOptions(): SzConfigOptions {
    let _options: SzConfigOptions = this.grpcParameters as SzConfigOptions;
  ...
  private createConfigFromDefinition(configDefinition: string) {
    return new Promise<SzConfig>((resolve, reject) => {
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        const res = new SzConfig(this.szConfigGrpcOptions);
      ...
      this.waitForReady(this.getDeadlineFromNow(), (err) => {
        ...
        this.client.getConfig(
          ...
          (err, res: GetConfigResponse) => {
            ...
            const conf = new SzConfig(this.szConfigGrpcOptions);
