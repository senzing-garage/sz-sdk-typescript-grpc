...
export class SzGrpcConfigManager extends SzGrpcBase implements SzConfigManager {
    ...
    /** @internal */
    public createConfig(definitionOrConfigId?: string | number): Promise<SzConfig> {
    ...
    public getTemplateConfig(): Promise<string> {
        return new Promise<string>((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                this.client.getTemplateConfig(request, this._metadata, (err, res: GetTemplateConfigResponse) => {
                    if(err) {
    ...
    registerConfig(configDefinition: string, comment?: string) {
        return new Promise<number>((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                this.client.registerConfig(request, this._metadata, (err, res: RegisterConfigResponse) => {
                    if(err) {
                        let _err = newException(err);
                        reject(_err);
                        throw _err;
    ...
    getDefaultConfigId(): Promise<number> {
        return new Promise<number>((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                this.client.getDefaultConfigId(request, this._metadata, (err, res: GetDefaultConfigIdResponse) => {
                    if(err) {
                        let _err = newException(err);
                        reject(_err);
                        throw _err;
    ...
    setDefaultConfig(configDefinition: string, comment?: string): Promise<number | SzError> | undefined {
        return new Promise<number>((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                this.client.setDefaultConfig(request, this._metadata, (err, res: SetDefaultConfigResponse) => {
                    if(err) {
                        let _err = newException(err);
                        reject(_err);
                        throw _err;
    ...
    setDefaultConfigId(configId: number): Promise<number | SzError> | undefined {
        return new Promise<number>((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                this.client.setDefaultConfigId(request, this._metadata, (err, res: SetDefaultConfigIdResponse) => {
                    if(err) {
                        let _err = newException(err);
                        reject(_err);
                        throw _err;
    ...
    replaceDefaultConfigId(currentDefaultConfigId: number, newDefaultConfigId: number) {
        return new Promise<string>((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                this.client.replaceDefaultConfigId(request, this._metadata, (err, res: ReplaceDefaultConfigIdResponse) => {
                    if(err) {
                        let _err = newException(err);
                        reject(_err);
                        throw _err;
    ...
    private createConfigFromConfigId(configId: number) {
        return new Promise<SzConfig>((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                request.setConfigId(configId);
                this.client.getConfig(request, this._metadata, (err, res: GetConfigResponse) => {
                    if(err) {
                        let _err = newException(err);
                        reject(_err);
                        throw _err;
